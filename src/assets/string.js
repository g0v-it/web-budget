export default{
    ...
    "$GLOBAL_NAME":"stato",
    "$TOP_PARTITION_FILTER_HINT":"Scegli i ministeri a cui sei interessato",
    "$SECOND_PARTITION_FILTER_HINT":"Scegli le missioni a cui sei interessato",
    "$TOP_PARTITION_FILTER_TEXT":"Filtra per ministero",
    "$SECOND_PARTITION_FILTER_TEXT":"Filtra per missione",
    "$MAIN_TITLE":"Legge di Bilancio",
    "$INFO_TOTAL_LABEL":"Spese totali: ",
    "$INFO_TOTAL_FILTERED_LABEL":"Spese filtrate: ",
    "$INFO_LAST_UPDATE":"Aggiornato al ",
    "$DATA_SOURCE_TEXT":"Elaborazione su dati del Ministero dell'Economia e delle Finanze",
    "$PERCENTAGE_EXPLANATION_TEXT":"Variazione rispetto alla legge di bilancio",
    "$TOOLTIP_PERCENTAGE":"Percentuale:",
    "$TOOLTIP_PERCENTAGE_MEANING_1":"sul totale del bilancio:", 
    "$TOOLTIP_PERCENTAGE_MEANING_2":"sul ministero di appartenenza:", 
    "$TOOLTIP_PERCENTAGE_MEANING_3":"sulla missione di appartenenza:",
