<template>
  <div class="account-item">
    ...
    <p class="top-partition">{{string['$TOP_PARTITION']}}: {{ account.partitions.top_partition }}  </p>
    <p class="second-partition">{{string['$SECOND_PARTITION']}}: {{ account.partitions.second_partition }}</p>
