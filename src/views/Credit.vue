<template>
  <div class="container">
    ...
    <p>Tutto il codice, sia relativo alla visualizzazione sia della piattaforma di gestione dei dati è disponibile
    con licenza Open Source su GitHub rispettivamente nei  repository
      <a href="https://github.com/g0v-it/web-budget"> web-budget</a> e <a href="https://github.com/g0v-it/data-budget">data-budget</a>.
    </p>
    ...
    codice senza cui questo progetto non esisterebbe. In particolare a  <a href="https://bost.ocks.org/mike/">Mike Bostock</a>
      ...
      <a href="http://linkeddata.center/"><img
